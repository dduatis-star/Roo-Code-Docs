...
The Slack integration requires a **Team Plan**. [Start a free 14-day trial](https://app.roocode.com/checkout/team) to try it out, or [sign up from our pricing page](https://roocode.com/pricing) if you're new to Roo Code Cloud.

### Connecting Slack

You'll be prompted to connect to Slack when first signing up. If you skip it, you can do it later:

1. Go to **Organization Settings** (top right user menu)
2. Click "Connect" under Integrations and complete the OAuth flow
3. Add `@Roomote` to the channels where you want it available
